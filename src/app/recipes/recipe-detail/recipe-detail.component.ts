...
export class RecipeDetailComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //        });
    //       })).subscribe(recipes => {
    //         this.receipe = recipes;
    //       });
    //   });

    // Above code snippet we can do this way also
  ...
  onAddToShoppingList() {
   // this.recipeService.addIngredientsToShoppingLists(this.receipe.ingredients);
   this.store.dispatch(new ShoppingListAction.AddIngredients(this.receipe.ingredients));
  }
